...
public class AlterarDados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(40, 20, 110, 20);
        ...
        lblExcluirConta.setBounds(380, 30, 210, 20);

        lblCargo.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblCargo.setText("Alterar cargo:");
        getContentPane().add(lblCargo);
        lblCargo.setBounds(60, 310, 90, 20);

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("Alterar telefone:");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(40, 140, 110, 20);
        getContentPane().add(txtUsuario);
        txtUsuario.setBounds(160, 20, 180, 22);
        getContentPane().add(txtSenha);
        txtSenha.setBounds(160, 60, 180, 22);
        getContentPane().add(txtNome);
        txtNome.setBounds(160, 100, 180, 22);
        getContentPane().add(txtTelefone);
        txtTelefone.setBounds(160, 140, 180, 22);
        getContentPane().add(txtEmail);
        txtEmail.setBounds(160, 182, 180, 30);
        ...
        lblIdFuncionario.setBounds(10, 270, 140, 16);
        ...
        btnConcluir.setBounds(365, 350, 80, 22);
        ...
        btnExcluirConta.setBounds(440, 60, 90, 30);

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Alterar email:");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(40, 180, 110, 30);
        getContentPane().add(txtCargo);
        txtCargo.setBounds(160, 310, 180, 22);
